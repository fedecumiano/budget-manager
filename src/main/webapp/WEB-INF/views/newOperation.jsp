...
<head>
    ...
    <body>
        ...
        <div class="container mt-4">
            <form:form modelAttribute="operation" action="/newOperation" method="POST">
                <div class="form-group col-sm-6">
                    <h1>Register an operation</h1>
                    ...
                    <div class="form-group">
                        ...
                        <form:input type="text" path="description" class="form-control" id="idDescription" placeholder="Input description" />
                    </div>
                    <div class="form-group">
                        <label for="idAmount">Amount: </label>
                        <form:input type="text" path="amount" class="form-control" id="idAmount" placeholder="$" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <form:select id="idType" class="form-control" path="type">
                            ...
                            <form:option value="spent">Spent</form:option>
                        </form:select>
                    </div>
                    <form:input id="username" name="username" type="hidden" value="${user.username}" path="username"/>
